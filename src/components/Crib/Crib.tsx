...
export default function Crib({ cards, onChange }: CribProps) {
  ...
  return (
    <section className="card-panel">
      <div className="panel-heading">
        <div>
          <p className="panel-label">Crib</p>
          <h2>Optional crib scoring area.</h2>
        </div>
      </div>

      <div className="card-grid">
        {cards.map((card, index) => (
          <div className="card-input" key={`crib-card-${index + 1}`}>
